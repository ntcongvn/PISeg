...
class MaskFormerHead(nn.Module):
    ...
    def forward(self, features,texture_features=None, mask=None):
        return self.layers(features,texture_features, mask)

    def layers(self, features,texture_features=None, mask=None):
        mask_features, transformer_encoder_features, multi_scale_features = self.pixel_decoder.forward_features(features,texture_features)
