...
__all__ = ["POLYPInstanceTestNewBaselineDatasetMapper"]


class POLYPInstanceTestNewBaselineDatasetMapper:
    """
    ...
    def __init__(
        ...
        *,
        ...
        logger.info(f"[POLYPInstanceTestNewBaselineDatasetMapper] Augmentations used in {mode}: {augmentations}")
    ...
    def __call__(self, dataset_dict):
        ...
        if self.texture_extractor_enable is True:
          ...
          texture_image=ExpandTexture(np.array(texture_image,dtype=float),texture_image.shape[0],texture_image.shape[1])
