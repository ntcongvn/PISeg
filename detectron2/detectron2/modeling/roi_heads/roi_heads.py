...
class ROIHeads(torch.nn.Module):
    ...
    def from_config(cls, cfg):
        return {
            "batch_size_per_image": cfg.MODEL.ROI_HEADS.BATCH_SIZE_PER_IMAGE,         #512
            "positive_fraction": cfg.MODEL.ROI_HEADS.POSITIVE_FRACTION,               #0.25
            "num_classes": cfg.MODEL.ROI_HEADS.NUM_CLASSES,                           #2
            "proposal_append_gt": cfg.MODEL.ROI_HEADS.PROPOSAL_APPEND_GT,             #True
